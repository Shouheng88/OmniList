...
public class SettingsSecurity extends BaseFragment {
    ...
    public static SettingsSecurity newInstance() {
        Bundle args = new Bundle();
        SettingsSecurity fragment = new SettingsSecurity();
    ...
    private void showInputDialog() {
        new MaterialDialog.Builder(getActivity())
                ...
                .input(getString(R.string.input_the_freeze_minutes_in_minute),
                        String.valueOf(lockPreferences.getPasswordFreezeTime()),
    ...
    private void showQuestionEditor() {
        DialogSecurityQuestionLayoutBinding binding = DataBindingUtil.inflate(
                ...
                R.layout.dialog_security_question_layout,
                null,
                false);
