...
public class SettingsBackup extends BaseFragment {
    ...
    public static SettingsBackup newInstance() {
        ...
        SettingsBackup fragment = new SettingsBackup();
    ...
    private void setPreferenceClickListeners() {
        ...
        findPreference(R.string.key_import_from_external_storage).setOnPreferenceClickListener(preference -> {
            PermissionUtils.checkStoragePermission((CommonActivity) getActivity(), this::showExternalBackupImport);
            return true;
        });
        findPreference(R.string.key_delete_external_storage_backup).setOnPreferenceClickListener(preference -> {
            PermissionUtils.checkStoragePermission((CommonActivity) getActivity(), this::showExternalBackupDelete);
            return true;
        });

        prefTimeInterval = findPreference(R.string.key_synchronize_time_interval);
