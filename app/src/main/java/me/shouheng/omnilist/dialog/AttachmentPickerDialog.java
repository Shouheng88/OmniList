...
public class AttachmentPickerDialog extends DialogFragment {
    ...
    private void resolveRecordEvent() {
        ...
        PermissionUtils.checkRecordPermission((BaseActivity) getActivity(), () -> {
            if (onPickAudioSelectedListener != null){
                onPickAudioSelectedListener.onSelectedAudioRecord();
            }
            dismiss();
        });
    }
    ...
    public static class Builder implements Serializable {
        ...
        public Builder setOnPickAudioSelectedListener(OnPickAudioSelectedListener onItemSelectedListener) {
            this.onPickAudioSelectedListener = onItemSelectedListener;
            return this;
        }
