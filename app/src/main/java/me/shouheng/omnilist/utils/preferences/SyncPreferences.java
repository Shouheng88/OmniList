...
public class SyncPreferences extends BasePreferences {
    ...
    public void setBackupOnlyInWifi(boolean isOnlyWifi) {
        putBoolean(R.string.key_synchronize_only_wifi, isOnlyWifi);
    }
    ...
    public SyncTimeInterval getSyncTimeInterval() {
        return SyncTimeInterval.getTypeById(getInt(R.string.key_synchronize_time_interval, SyncTimeInterval.EVERY_30_MINUTES.id));
    }

    public void setSyncTimeInterval(SyncTimeInterval syncTimeInterval) {
        putInt(R.string.key_synchronize_time_interval, syncTimeInterval.id);
    }
